 ...
 * @description Encapsulates the business logic for managing institutions.
...
export class InstitutionService {
   ...
   * @param {Partial<Institution>} institutionData - An object containing the fields to update.
